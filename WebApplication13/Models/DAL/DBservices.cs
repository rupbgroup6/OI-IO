...
namespace WebApplication13.Models.DAL
{
    public class DBservices
    {
        ...
        private String BuildInsertCommandUsers(User u)
        {
            ...
            StringBuilder sb = new StringBuilder();
            // use a string builder to create the dynamic string
            sb.AppendFormat("Values('{0}', '{1}' ,'{2}', '{3}')", u.UserId, u.Password, u.Email, u.Admin);
            String prefix = "INSERT INTO TBUsers " + "(UserId, Password, Email, Admin) ";
            command = prefix + sb.ToString();
        ...
        //--------------------------------------------------------------------------------------------------
        // This method gets the UserInfo for the admin 
        //--------------------------------------------------------------------------------------------------
        public List<UserInfo> GetUserInfo()
        {
            ...
            try
            {
                ...
                String selectSTR = "select * from TBUserInfo";
